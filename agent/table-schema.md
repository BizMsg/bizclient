...
|       컬럼 명       |      적용되는 발송종류      | 필수입력 여부 | 기본값 |   타입   |  길이  |                                                                        설명                                                                       |
| :--------------: | :-----------------: | :-----: | :-: | :----: | :--: | :---------------------------------------------------------------------------------------------------------------------------------------------: |
...
|  ATTACHED\_FILE  | MMS/FAX/PHONE/AT/FT |    N    |     | String | 1000 |                                                 <p>[기본 MODE ]<br>첨부파일 전송 시 파일명<br>(여러 개일 경우,</p>                                                |
...
>
> 메시지 테이블은의 **CMID** 컬이은 **Primary Key** 로 잡혀 있으며, 로그테이블은 중복된 키 값을 허용할 수 있도록 PK가  잡혀있지 않습니다.\
