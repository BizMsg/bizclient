...
|  msgKey1 |  2  | HTTP |                                                                                                                                           [http://www.daou.co.kr/file/jpg.jpg](http://www.daou.co.kr/file/jpg.jpg)                                                                                                                                          |
|  msgKey1 |  3  | JSON | <pre><code>{
  "button": [
    {
      "name": "미리 주문하기",
      "type": "WL",
...
&#x20; 2\. 기존 BIZ_RCS 테이블이 존재한다면_ AGENCY\_ID VARCHAR(20) 컬럼을 추가합니다.
